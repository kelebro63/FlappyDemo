...
public class PlayState  extends State{
        ...
        for (int i = 0; i < tubes.size; i++) {
            ...
            if (camera.position.x - (camera.viewportWidth / 2) > tube.getPosTopTube().x +
                    tube.getTopTube().getWidth()) {
                      ...
                      //  System.out.println("tube index = " + tubes.indexOf(tube, false) + " reposition tube " + tube.getPosTopTube().x + ((Tube.TUBE_WIDTH + TUBE_SPACING) * TUBE_COUNT));
            }
    ...
    public void render(SpriteBatch sb) {
        ...
        System.out.println("bird.getPosition().x = " + bird.getPosition().x);
        for (Tube tube : tubes) {
